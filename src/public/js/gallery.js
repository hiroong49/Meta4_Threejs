...
import { MeshBasicMaterial, DoubleSide, Mesh } from 'https://cdn.skypack.dev/three';
...
randomBtn.style.cssText = 'position: absolute; left: 30px; top: 30px; color: #F45866;';
randomBtn.innerHTML = 'Random';
btnWrapper.append(randomBtn);

const sphereBtn = document.createElement('button');
sphereBtn.dataset.type = 'sphere';
sphereBtn.style.cssText = 'position: absolute; left: 30px; top: 70px; color: #F45866;';
...
randomBtn.addEventListener('mouseover', function() {
    randomBtn.style.cssText = 'position: absolute; left: 30px; top: 30px; color: white;';
...
sphereBtn.addEventListener('mouseover', function() {
    sphereBtn.style.cssText = 'position: absolute; left: 30px; top: 70px; color: white;';
